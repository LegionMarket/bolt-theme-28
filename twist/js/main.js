;(function () {
	...
	var exploreAnimate = function() {
		...
		var explore = $('#legionmarket-explore');
		if ( explore.length > 0 ) {	
	...
	var testimonyAnimate = function() {
		var testimony = $('#legionmarket-testimony');
	...
	var pricingAnimate = function() {
		var pricing = $('#legionmarket-pricing');
		if ( pricing.length > 0 ) {	
	...
	var trustedAnimate = function() {
		var trusted = $('#legionmarket-trusted');
		if ( trusted.length > 0 ) {	
	...
	var footerAnimate = function() {
		var footer = $('#legionmarket-footer');
		if ( footer.length > 0 ) {	
	...
	var counterWayPoint = function() {
		if ($('#legionmarket-counter-section').length > 0 ) {
			$('#legionmarket-counter-section').waypoint( function( direction ) {
