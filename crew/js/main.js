;(function () {
	...
	var servicesAnimate = function() {
		...
		if ( $('#legionmarket-our-services').length > 0 ) {	
			$('#legionmarket-our-services .to-animate').each(function( k ) {
	...
	var servicesWayPoint = function() {
		...
		if ( $('#legionmarket-our-services').length > 0 ) {
			$('#legionmarket-our-services').waypoint( function( direction ) {
	...
	var featuresAnimate = function() {
		...
		if ( $('#legionmarket-features').length > 0 ) {	
			$('#legionmarket-features .to-animate').each(function( k ) {
	...
	var featuresWayPoint = function() {
		...
		if ( $('#legionmarket-features').length > 0 ) {
			$('#legionmarket-features').waypoint( function( direction ) {
	...
	var testimonialsAnimate = function() {
		...
		if ( $('#legionmarket-testimonials').length > 0 ) {	
			$('#legionmarket-testimonials .to-animate').each(function( k ) {
	...
	var testimonialsWayPoint = function() {
		...
		if ( $('#legionmarket-testimonials').length > 0 ) {
			$('#legionmarket-testimonials').waypoint( function( direction ) {
	...
	var pricingAnimate = function() {
		...
		if ( $('#legionmarket-pricing').length > 0 ) {	
			$('#legionmarket-pricing .to-animate').each(function( k ) {
	...
	var pricingWayPoint = function() {
		...
		if ( $('#legionmarket-pricing').length > 0 ) {
			$('#legionmarket-pricing').waypoint( function( direction ) {
	...
	var pressAnimate = function() {
		...
		if ( $('#legionmarket-press').length > 0 ) {	
			$('#legionmarket-press .to-animate').each(function( k ) {
	...
	var pressWayPoint = function() {
		...
		if ( $('#legionmarket-press').length > 0 ) {
			$('#legionmarket-press').waypoint( function( direction ) {
