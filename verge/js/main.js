;(function () {
	...
	var scrlTop =  function() {
		$('.legionmarket-gotop').click(function(event){
			$('html, body').animate({
		        scrollTop: 0
		    }, 500, 'easeInOutExpo');
	...
	var imgHover = function() {
		$('.legionmarket-project > a').mouseenter(function(){
			$(this).find('.legionmarket-overlay, .legionmarket-overlay-text').stop().animate({
				opacity: 1
			}, 400 );
		}).mouseleave(function(){
			$(this).find('.legionmarket-overlay, .legionmarket-overlay-text').stop().animate({
	...
	var accordion = function() {
		$('.js-legionmarket-accordion-toggle').click(function(event){
			var $this = $(this);
			if ( $this.closest('.legionmarket-accordion').find('.legionmarket-accordion-body').is(':visible') ) {
				$this.text('Show More');
			} else {
				$this.text('Show Less');
			}
			$this.closest('.legionmarket-accordion').find('.legionmarket-accordion-body').slideToggle(400, 'easeInOutExpo');
			event.preventDefault();
		})
	};
	...
	var animateSocial = function() {
		if ( $('#legionmarket-intro-social').length > 0 ) {	
			$('#legionmarket-intro-social > a').each(function( k ) {
	...
	var heroWayPoint = function() {
		if ( $('#legionmarket-header').length > 0 ) {
			$('#legionmarket-header').waypoint( function( direction ) {
