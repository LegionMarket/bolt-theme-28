;(function () {
	...
	var sliderSayings = function() {
		$('#legionmarket-sayings .flexslider').flexslider({
			animation: "slide",
			slideshowSpeed: 5000,
			directionNav: false,
			controlNav: true,
	...
	var offcanvasMenu = function() {
		...
		$('body').prepend('<a href="#" class="js-legionmarket-nav-toggle legionmarket-nav-toggle"><i></i></a>');

		$('.legionmarket-main-nav .legionmarket-menu-1 a, .legionmarket-main-nav .legionmarket-menu-2 a').each(function(){

			var $this = $(this);

			$('#legionmarket-offcanvas').append($this.clone());

		});
		// $('#legionmarket-offcanvas').append
	};
	...
	var scrolledWindow = function() {
		...
		$(window).scroll(function(){
			...
			$('#legionmarket-home .legionmarket-text').css({
		   ...
		   if (scrollPos > 300) {
				$('#legionmarket-home .legionmarket-text').css('display', 'none');
			} else {
				$('#legionmarket-home .legionmarket-text').css('display', 'block');
			}
	...
	var navActive = function(section) {
		...
		$('.legionmarket-main-nav a[data-nav-section], #legionmarket-offcanvas a[data-nav-section]').removeClass('active');
		$('.legionmarket-main-nav, #legionmarket-offcanvas').find('a[data-nav-section="'+section+'"]').addClass('active');
	...
	var sayingsAnimate = function() {
		var sayings = $('#legionmarket-sayings');
		if ( sayings.length > 0 ) {	
	...
	var featureAnimate = function() {
		var feature = $('#legionmarket-featured');
		if ( feature.length > 0 ) {	
	...
	var eventsAnimate = function() {
		var events = $('#legionmarket-events');
		if ( events.length > 0 ) {	
